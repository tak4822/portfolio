export default [
  {
    ...
    date: 'Jun - Mar 2018',
    shortDesc: 'As a front-end developer, I assisted my team to create a mobile App to find buddies to play board game with. Now on KickStarter.',
  ...
  },
  {
    ...
    date: 'Sep - Dec 2017',
    shortDesc: 'A portfolio site with custom CMS for Ken Priebe, who is an auther and animater. Minimalist design to focus on his works itself.',
  ...
  },
  {
    ...
    date: 'Jun - Sep 2017',
    shortDesc: 'A design company specializes in food and beverage industry. Created a modern design that represents the company\'s skills and services provided to its customers.',
  ...
  },
  {
    ...
    date: 'Oct 2017',
    shortDesc: 'A website for a type design company. Created an edgy and energetic look to reflect the company\'s design direction in typography.',
  ...
  },
  {
    ...
    date: 'May - Jul 2017',
    shortDesc: 'A website for B&B hotel that also has a winery. Fancy design style so their customers imagine romantic getaway.',
  ...
  },
  {
    ...
    date: 'Sep 2017',
    shortDesc: 'An e-commerce site for Yoga and fitness clothing and instrument. Designed for highly fashion-conscious women in their 30\'s',
    subTitle: 'Elegant and friendly E-commerce',
    client: 'Vanarts project',
    color: '#c6b7d9',
    role: ['Website & Logo Design', 'Development'],
    skills: ['PHP', 'CMS', 'Responsible', 'Website & Logo Design', 'JQuery'],
    description: ['An e-commerce site for Yoga and fitness clothing and instrument. Designed for highly fashion-conscious women in their 30\'s. Challenged combining modern locking and user-friendly UI design. As a developer, developed based on MVC principle with reasonably organized relational database.'],
  ...
  },
  {
    ...
    date: 'Aug 2017',
    shortDesc: 'Inspired by CBS\'s Gastrotypographicalassemblage. Challenged a viewer\'s reading convention by using design principles and typographic styles.',
